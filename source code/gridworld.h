...
public:
	...
	void displayPath();
	void displayDstarLitePath();
	void displaylpastarPath();
	void displayMap();
   ...
   //------------------------------------------------
	...
	Coordinates markCell_col_row(int col, int row, int fillColour, int outlineColour, bool showRobot = false);
   ...
   int getFieldX1(){
	...
	void markCell_col_row_details(int col, int row, int fillColour, int outlineColour, bool showRobot = false);
	...
	friend void copyMazeToDisplayMap(GridWorld &gWorld, DStarLite* dstarlite);
	friend void copyDisplayMapToMaze(GridWorld &gWorld, DStarLite* dstarlite);
